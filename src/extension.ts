...
export function activate(context: ExtensionContext) {
  ...
  commands.registerCommand('javascript-test-runner-reloaded.run.test', runTestCommand);
  commands.registerCommand('javascript-test-runner-reloaded.debug.test', debugTestCommand);
}
